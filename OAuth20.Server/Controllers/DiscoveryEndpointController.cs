...
public class DiscoveryEndpointController : ControllerBase
{
    ...
    public JsonResult GetConfiguration()
    {
        var response = new DiscoveryResponse
        {
            ...
            authorization_endpoint = "https://localhost:44349/Home/Authorize",
            token_endpoint = "https://localhost:44349/Home/Token",
            ...
            service_documentation = "https://localhost:44349/connect/service_documentation.html",
